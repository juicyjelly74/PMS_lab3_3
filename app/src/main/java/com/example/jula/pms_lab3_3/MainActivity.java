package com.example.jula.pms_lab3_3;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        final CharSequence[] items = {getText(R.string.red), getText(R.string.yellow), getText(R.string.green),
                getText(R.string.blue), getText(R.string.purple), getText(R.string.picture)
        };
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int item) {
                switch (item) {
                    ...
                    case 4: {
                        relativeLayout.setBackgroundResource(R.color.purpleColor);
                        Toast.makeText(context, R.string.purple, Toast.LENGTH_LONG).show();
                        break;
                    }
                    case 5: {
                        Toast.makeText(context, R.string.picture, Toast.LENGTH_LONG).show();
